...
func (opts *stackCreateOptions) GetTeams() []string {
	return opts.teams
}
...
func newStackInitCmd() *cobra.Command {
	...
	cmd.PersistentFlags().StringArrayVar(&teams, "teams", nil, "An assigment from team "+
		"names to the permissions they should have on this stack, "+
		"once created (Pulumi Service backend only)")
	return cmd
}
